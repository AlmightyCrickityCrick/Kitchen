...
data class Order (val order_id : Int, var items: ArrayList<Int>, var priority:Int, var max_wait : Int,
                  var pick_up_time : Long, var table_id: Int, var waiter_id: Int)
...
data class FinishedOrder(
    ...
    var cooking_time: Long = 0, var table_id: Int, var waiter_id: Int, var cooking_details: ArrayList<CookingDetail>?=null){
